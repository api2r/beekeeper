...
#> ✔ Creating /tmp/RtmpYHNcPJ/file44944219bdf/.
#> ✔ Setting active project to "/tmp/RtmpYHNcPJ/file44944219bdf".
#> ✔ Creating R/.
#> ✔ Writing DESCRIPTION.
#> Package: file44944219bdf
...
generate_pkg_auth()
#> Warning: cannot open file '/__w/beekeeper/beekeeper/docs/reference/_beekeeper.yml': No such file or directory
