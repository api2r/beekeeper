...
#' @param max_amount_outstanding_beginning (length-1 \code{\link[base:double]{double}}, optional)
#' @param sort_hide_null (length-1 \code{\link[base:logical]{logical}}, optional) Hide null values on sorted column(s).
#' @param min_payment_period (length-1 \code{\link[base:double]{double}}, optional)
#' @param max_amount_incurred (length-1 \code{\link[base:double]{double}}, optional)
#' @param nature_of_debt (length-1 \code{\link[base:character]{character}}, optional)
#' @param per_page (length-1 \code{\link[base:list]{list}}, optional) The number of results returned per page. Defaults to 20.
#' @param max_amount_outstanding_close (length-1 \code{\link[base:double]{double}}, optional)
...
#' @param min_date (length-1 \code{\link[base:Date]{Date}}, optional) Minimum load date
...
#' @param min_amount_outstanding_close (length-1 \code{\link[base:double]{double}}, optional)
...
#' @param max_payment_period (length-1 \code{\link[base:double]{double}}, optional)
#' @param min_image_number (length-1 \code{\link[base:character]{character}}, optional) Minium image number of the page where the schedule item is reported
#' @param min_amount_incurred (length-1 \code{\link[base:double]{double}}, optional)
...
#' @param image_number (length-1 \code{\link[base:list]{list}}, optional) An unique identifier for each page where the electronic or paper filing is reported.
