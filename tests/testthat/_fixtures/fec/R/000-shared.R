...
#' @param api_key (length-1 `character`) An API key provided by the API provider. This key is not clearly documented in the API description. Check the API documentation for details.
#'
#' @name .shared-params
#' @keywords internal
NULL
