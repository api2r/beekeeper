...
- [x] **pre-0.1.0: Infrastructure.**
  ...
  - I also realized I need a package for wrapping {httr2} calls.
...
- [x] **0.3.0: Batching and rate limiting.**
  ...
  - Changes:
    ...
    - This milestsone resulted in the [pagination](pagination.html) vignette.
...
- [ ] **0.5.0: More robust scaffolding.**
  ...
  - Changes:
    - Type checking is implemented for many parameter types (logical, character, integer, double), and infrastructure is in place to addd the rest as they become available in the spun-off [{stbl}](https://stbl.wrangle.zone) package.
